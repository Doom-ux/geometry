...
double*
retTrin(double x1, double x2, double x3, double y1, double y2, double y3)
{
    double* A;
...
void InterTT(double** D, int u, int k)
{
    ...
    for (int j = 0; j < k; j++) {
        if (j != u) {
            flag = 0;
            for (int i = 0; i < 3; i++) {
                v1 = (A[i][2] - A[i][0]) * (D[j][3] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][0] - A[i][0]);

                v2 = (A[i][2] - A[i][0]) * (D[j][4] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][1] - A[i][0]);

                v3 = (D[j][1] - D[j][0]) * (A[i][1] - D[j][3])
                        - (D[j][4] - D[j][3]) * (A[i][0] - D[j][0]);

                v4 = (D[j][1] - D[j][0]) * (A[i][3] - D[j][3])
                        - (D[j][4] - D[j][3]) * (A[i][2] - D[j][0]);
            ...
            for (int i = 0; i < 3; i++) {
                v1 = (A[i][2] - A[i][0]) * (D[j][4] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][1] - A[i][0]);

                v2 = (A[i][2] - A[i][0]) * (D[j][5] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][2] - A[i][0]);

                v3 = (D[j][2] - D[j][1]) * (A[i][1] - D[j][4])
                        - (D[j][5] - D[j][4]) * (A[i][0] - D[j][1]);

                v4 = (D[j][2] - D[j][1]) * (A[i][3] - D[j][4])
                        - (D[j][5] - D[j][4]) * (A[i][2] - D[j][1]);
            ...
            for (int i = 0; i < 3; i++) {
                v1 = (A[i][2] - A[i][0]) * (D[j][5] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][2] - A[i][0]);

                v2 = (A[i][2] - A[i][0]) * (D[j][3] - A[i][1])
                        - (A[i][3] - A[i][1]) * (D[j][0] - A[i][0]);

                v3 = (D[j][0] - D[j][2]) * (A[i][1] - D[j][5])
                        - (D[j][3] - D[j][5]) * (A[i][0] - D[j][2]);

                v4 = (D[j][0] - D[j][2]) * (A[i][3] - D[j][5])
                        - (D[j][3] - D[j][5]) * (A[i][2] - D[j][2]);
...
int main()
{
    ...
    for (int i = 0; i < t; i++) {
        printf("\n %d. Triangle:%.0lf %.0lf,%.0lf %.0lf,%.0lf %.0lf,%.0lf "
               "%.0lf\n",
               i + 1,
               D[i][0],
               D[i][3],
